...
import com.example.greentipskotlin.databinding.ActivityAdminDetailsInsertBinding
import java.util.Calendar

class AdminDetailsInsert : AppCompatActivity() {

    private lateinit var binding: ActivityAdminDetailsInsertBinding
    private val model: EmployeeViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAdminDetailsInsertBinding.inflate(layoutInflater)
            ...
            model.getEmployeeIdByUsername(username).observe(this) { employeeId ->
                ...
                insertButton.setOnClickListener {
                    ...
                    if (shiftStart.isNotEmpty() && shiftEnd.isNotEmpty() && employeeId != null) {
                        ...
                        Toast.makeText(
                            this,
                            "Admin details inserted successfully!",
                            Toast.LENGTH_SHORT
                        ).show()
